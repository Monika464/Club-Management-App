...
// import translations from "./stopmembershipadmin-translations";
...
//           })
//             .then(() =>
//               console.log("stop date for passa user update succesful")
//             )
//             .then(() => setStopDate(null))
//             .then(() => setisSent(true))
//             .then(() => setFinalDebt(null));
...
//       {dueDate && (
//         <>
//           {compareAsc(dueDate?.toMillis(), new Date()) === 1 ? (
//             <div className="archive">
//               <p>
//                 Czy na pewno chcesz zakończyć uczestnictwo w treningach?
//                 Treningi zostana zakonczone:{" "}
//               </p>
//               <p>
...
//           </p>
//           <p>
//             <DateFnsFormat element={stopDate} />
//           </p>
//         </div>
//       )}
...
const StopMembershipAdmin2: React.FunctionComponent = () => {
  ...
  return (
    <>
      ...
      {currentUserPausaDate && <p>{t.pausingUser}</p>}

      {dueDate && (
        <>
          {compareAsc(dueDate?.toMillis(), new Date()) === 1 ? (
            <div className="archive">
              <p>{t.confirmMembershipEnd} </p>
              <p>
                <DateFnsFormat
                  element={dueDate}
      ...
      {/* {finalDebt && <p>istniejące zadłużenie: {finalDebt} treningów</p>} */}
      {finalDebt && (
        <p>{t.existingDebt.replace("{finaldebt}", finalDebt.toString())}</p>
      )}
