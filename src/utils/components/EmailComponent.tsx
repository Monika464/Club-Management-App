...
export const EmailComponent: React.FunctionComponent<IEmailprops> = (props) => {
  ...
  const [freshMessagestoTrainer, setFreshMessagestoTrainer] = useState<
    IFreshMessage[] | null
  >(null);
  const [freshMessagestoUser, setFreshMessagestoUser] = useState<
    IFreshMessage[] | null
  >(null);
  ...
  return (
    <div>
      ...
      {isShaking ? (
        <img
          src={props.isMO ? mailblurred : mail}
